...
import type { InspirationCategory } from "@/components/backlog/backlog-types";
...
export const INSPIRATION_CATEGORIES: InspirationCategory[] = [
  {
    ...
    goals: [
      ...
      { id: "resolve-pain", label: "Resolve recurring pain", icon: RiFirstAidKitLine },
      { id: "mobility", label: "Daily mobility routine", icon: RiHeartLine },
      { id: "mood-tracking", label: "Track mood and symptoms", icon: RiMentalHealthLine },
      { id: "sleep-routine", label: "Consistent sleep schedule", icon: RiMoonLine },
  ...
  },
  {
    ...
    goals: [
      ...
      { id: "public-speaking", label: "Practice public speaking", icon: RiMicLine },
      ...
      { id: "industry-reading", label: "Industry reading", icon: RiNewspaperLine },
    ],
  },
  {
    lifeArea: LIFE_AREAS_BY_ID.get("relationships")!,
    goals: [
      { id: "quality-time-partner", label: "Quality time with partner", icon: RiHeart2Line },
      ...
      { id: "active-listening", label: "Practice active listening", icon: RiUserHeartLine },
      { id: "gratitude-partner", label: "Express gratitude to partner", icon: RiEmotionHappyLine },
  ...
  },
  {
    ...
    goals: [
      { id: "budget-review", label: "Weekly budget review", icon: RiCalculatorLine },
      ...
      { id: "financial-reading", label: "Financial literacy reading", icon: RiBookOpenLine },
  ...
  },
  {
    ...
    goals: [
      ...
      { id: "self-reflection", label: "Weekly self-reflection", icon: RiUserSearchLine },
      ...
      { id: "course", label: "Take an online course", icon: RiGraduationCapLine },
    ],
  },
  {
    ...
    goals: [
      ...
      { id: "cooking-creative", label: "Try new recipes", icon: RiRestaurantLine },
    ],
  },
  {
    lifeArea: LIFE_AREAS_BY_ID.get("community")!,
    goals: [
      { id: "volunteering", label: "Volunteer regularly", icon: RiHandHeartLine },
      { id: "local-events", label: "Attend local events", icon: RiCalendarEventLine },
  ...
  },
  {
    ...
    goals: [
      { id: "outdoor-adventure", label: "Outdoor adventures", icon: RiCompass3Line },
      ...
      { id: "social-sports", label: "Social sports leagues", icon: RiFootballLine },
    ],
  },
];
