...
5. **Progress Metrics:** Switch between completed hours and focused hours metrics
6. **Budget Awareness:** Visual feedback when scheduled time exceeds available budget
