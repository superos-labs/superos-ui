 ...
 * =============================================================================
 *
 * Composed Dropdown Menu primitive built on top of Radix DropdownMenu.
 *
 * Provides a styled menu for action lists triggered by a button or icon,
 * supporting groups, checkboxes, radio items, separators, and nested submenus.
 *
 * -----------------------------------------------------------------------------
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Expose composed DropdownMenu primitives (Root, Trigger, Content, etc.).
 ...
 * - Content width is tied to trigger width when possible.
 * - Submenus render a chevron indicator automatically.
 *
 * -----------------------------------------------------------------------------
 * EXPORTS
 * -----------------------------------------------------------------------------
