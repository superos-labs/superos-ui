 ...
 * =============================================================================
 *
 * Composed form field layout primitives.
 *
 * Provides a consistent structure for labeling, describing, grouping,
 * and displaying validation for form controls.
 *
 ...
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Provide layout containers for form fields and groups.
 * - Support vertical, horizontal, and responsive field orientations.
 * - Render labels, titles, descriptions, separators, and error messages.
 * - Normalize spacing and alignment across different input types.
 *
 * -----------------------------------------------------------------------------
 ...
 * - Field orientation is driven by CVA variants.
