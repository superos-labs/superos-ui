 ...
 * =============================================================================
 *
 * Composed Card layout primitive.
 *
 * Provides a structured container with consistent padding, typography,
 * and slot-based subcomponents for common card layouts.
 *
 * -----------------------------------------------------------------------------
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Render a styled card container.
 * - Provide layout slots (Header, Content, Footer, etc.).
 * - Support size variants for tighter layouts.
 *
 * -----------------------------------------------------------------------------
 * NON-RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Managing data fetching or state.
 * - Enforcing specific content semantics.
 *
 * -----------------------------------------------------------------------------
 * DESIGN NOTES
 * -----------------------------------------------------------------------------
 * - Uses data-slot attributes for internal composition.
 * - Card supports size: "default" | "sm".
