 ...
 * =============================================================================
 *
 * Composed input grouping primitives.
 *
 * Provides a wrapper around Input and Textarea that enables leading/trailing
 * addons, inline buttons, and block-level addons while maintaining consistent
 * focus, border, and validation styling.
 *
 * Used by components such as Combobox, search fields, and rich form inputs.
 *
 * -----------------------------------------------------------------------------
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Render a grouped input container with shared border and focus ring.
 * - Provide addon slots (icons, text, buttons).
 * - Bridge to shared Input, Textarea, and Button components.
 * - Normalize spacing and alignment across inline and block layouts.
 *
 * -----------------------------------------------------------------------------
 * NON-RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Managing input value or form state.
