...
/**
 * Subtask data for the SubtaskRow component.
 * Uses a normalized interface that can map from either:
 * - ScheduleTask subtasks (label/completed)
 * - BlockSubtask (text/done)
 */
