 ...
 * =============================================================================
 *
 * Composed Alert Dialog primitive built on top of Radix AlertDialog.
 *
 * Provides a styled, slot-based confirmation dialog with consistent layout,
 * animation, and button integration across the app.
 *
 * Wraps Radix primitives and adapts them to SuperOS design tokens, motion,
 * and Button variants.
 *
 * -----------------------------------------------------------------------------
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Expose a composed AlertDialog API (Root, Trigger, Content, etc.).
 * - Apply default styling, animations, and sizing.
 * - Provide layout primitives (Header, Footer, Media).
 * - Bridge Radix Action/Cancel with the shared Button component.
 *
 * -----------------------------------------------------------------------------
 * NON-RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Managing open/close state logic.
 * - Handling business rules for confirmations.
 * - Persisting or executing side effects.
 *
 * -----------------------------------------------------------------------------
 * DESIGN NOTES
 * -----------------------------------------------------------------------------
 * - Uses data-slot attributes to enable slot-based styling and composition.
 * - Content supports size variants ("default" | "sm").
 * - Action and Cancel are rendered via Button using `asChild`.
 *
 * -----------------------------------------------------------------------------
 * EXPORTS
 * -----------------------------------------------------------------------------
