 ...
 * =============================================================================
 *
 * Small inline status and metadata label.
 *
 * Used to display short pieces of contextual information such as states,
 * categories, or counts, with multiple visual variants.
 *
 ...
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Render a styled inline badge element.
 * - Support visual variants via CVA.
 * - Allow rendering as a child component via `asChild`.
 *
 * -----------------------------------------------------------------------------
 * NON-RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Managing interactive behavior beyond basic focus/hover styles.
 * - Handling semantic meaning or business logic of the label.
 *
 * -----------------------------------------------------------------------------
 * DESIGN NOTES
 * -----------------------------------------------------------------------------
