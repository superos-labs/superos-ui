 ...
 * =============================================================================
 *
 * Composed Context Menu primitive built on top of Radix ContextMenu.
 *
 * Provides a styled right-click / long-press menu with support for groups,
 * checkboxes, radio items, separators, labels, and nested submenus.
 *
 * -----------------------------------------------------------------------------
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Expose composed ContextMenu primitives (Root, Trigger, Content, etc.).
 * - Apply SuperOS styling, animations, and spacing.
 * - Support destructive variants, inset items, and keyboard focus states.
 * - Support checkbox, radio, and submenu patterns.
 *
 * -----------------------------------------------------------------------------
 * NON-RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Managing menu open/close state.
 ...
 * - Content and sub-content are rendered with motion and zoom/fade transitions.
 * - Submenus show a chevron indicator automatically.
 *
 * -----------------------------------------------------------------------------
 * EXPORTS
 * -----------------------------------------------------------------------------
