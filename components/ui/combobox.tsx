 ...
 * =============================================================================
 *
 * Composed Combobox (select / autocomplete) primitive built on top of Base UI.
 *
 * Provides a flexible, styled combobox supporting single selection, filtering,
 * and optional multi-select via chips.
 *
 * Integrates with InputGroup and Button to ensure consistent form styling.
 *
 * -----------------------------------------------------------------------------
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Expose composed Combobox primitives (Input, Content, Item, etc.).
 * - Apply SuperOS styling, animations, and layout.
 * - Support optional clear button and trigger button.
 * - Support multi-select chips with removable items.
 *
 * -----------------------------------------------------------------------------
 * NON-RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Managing selected values or filtering logic.
 * - Fetching or transforming option data.
 ...
 * - Content is rendered in a Portal and positioned via Positioner.
 * - Chips mode uses a separate anchor to size the popup.
 * - `useComboboxAnchor` provides a ref for anchoring content to custom elements.
 *
 * -----------------------------------------------------------------------------
 * EXPORTS
 * -----------------------------------------------------------------------------
