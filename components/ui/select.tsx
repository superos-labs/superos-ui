 ...
 * =============================================================================
 *
 * Composed Select (dropdown) primitive built on top of Radix Select.
 *
 * Provides a styled single-select dropdown with consistent trigger,
 * content, items, and scroll controls.
 *
 * -----------------------------------------------------------------------------
 * RESPONSIBILITIES
 * -----------------------------------------------------------------------------
 * - Expose composed Select primitives (Root, Trigger, Content, Item, etc.).
 * - Apply SuperOS styling, sizing, and animations.
 * - Support small and default trigger sizes.
 * - Render scroll buttons for long option lists.
 *
 * -----------------------------------------------------------------------------
 ...
 * - Selected item shows a check indicator.
 *
 * -----------------------------------------------------------------------------
 * EXPORTS
 * -----------------------------------------------------------------------------
