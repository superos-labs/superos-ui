...
function ExternalCalendarSyncSection({
  ...
  const hasAppearanceChanges = pendingOverride !== null && pendingOverride !== currentAppearance;
  const hasCustomLabelChanges = pendingOverride === "custom" && pendingCustomLabel !== currentCustomLabel;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5 p-4">
        ...
        {/* External Calendar Sync Section - only shown when goal is synced to an enabled calendar */}
